$(document).ready(function () {
    ...
    $('.contextMenuRow').on('dblclick', function () {
        ...
        $(location).attr('href', "/company-legal-subject/edit/" + rowId);
    });
        ...
        actions: [
            {
                ...
                iconClass: 'fa-pen',
                onClick: (id) => {
                    document.location.href = "/company-legal-subject/edit/" + id;
                }
            },
            {
                name: 'Удалить',
                ...
                onClick: (id) => {
                    if (confirm("Вы точно хотите удалить запись?")) {
                        document.location.href = "/company-legal-subject/delete/" + id;
                    }
                }
            }
        ]
